...
export const PAGE_LOADING_DELAY_MS = parseEnvMs('PAGE_LOADING_DELAY_MS', 500);
export const INSTRUCTION_EXECUTION_DELAY_MS = parseEnvMs('INSTRUCTION_EXECUTION_DELAY_MS', 500);
